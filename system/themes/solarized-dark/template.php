<?php
/**
 * Solarized Dark Theme - Haupt-Template
 * Verwendet Bootstrap 5 mit Solarized Dark Farbschema
 */
...
?>
<!DOCTYPE html>
<html lang="de" data-bs-theme="<?= htmlspecialchars($themeMode ?? 'dark') ?>">
<head>
    <meta charset="UTF-8">
...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 text-md-end">
                    <a href="/admin" class="text text-decoration-none">
    ...
    <script>
        ...
        // Code syntax highdarking (simple)
