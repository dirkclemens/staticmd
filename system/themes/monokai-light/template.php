<?php
/**
 * Monokai Light Theme - Haupt-Template
 * Verwendet Bootstrap 5 mit Monokai Light Farbschema
 */
...
<head>
    ...
    <!-- Monokai Light Theme CSS -->
    <style>
        :root {
            /* Monokai Light Colors */
            --monokai-bg: #fafafa;
            --monokai-paper: #ffffff;
            --monokai-text: #49483e;
            ...
            --monokai-pink: #f92672;
            --monokai-border: #e0e0e0;
            --monokai-sidebar: #f5f5f5;
        }
        ...
        .badge.bg-warning {
            ...
            color: var(--monokai-paper) !important;
        }
        ...
        footer {
            background-color: var(--monokai-comment);
            color: var(--monokai-paper);
